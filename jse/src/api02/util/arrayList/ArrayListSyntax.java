...
배열에 더  이상 저장공간 이 없으면 보다 큰 새로운 배열을 생성해서
기존의 배열에 저장된 내용을 새로운 배열에 복사한 다음 저장한다.
 * */

/*
java.util.Vector 의 차이점
- vector 는 멀티스페드에 대한 동기화가 되어 잇으나
- java.util.ArrayList는  동기화가 되어있지 않다.
 * */

/*
ArrayList 클래스
1. ArrayList와 Vector 클래스는 List 크기 변경이 가능하기 때문에
가능한 배열로 구현한 것으로 차이점은 Vector 클래스의 객체는 원래 
기본적으로 동기화 되지만 ArrayList는 그렇지 않다.
