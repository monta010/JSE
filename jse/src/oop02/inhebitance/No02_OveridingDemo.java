...
- Super가 가진 메소드를 상속해주나 같은 이름의 메소드가 Sub 에 존재한다면
	Sub에 잇는 메소드를 우선 사용해야 함
...
class Parents{
	void show(){
		System.out.println("Parents 의 show()메소드를 수행..");
...
class Child extends Parents{
	void show(){
		System.out.println("Child 의 show()메소드를 수행..");
	}
}

public class No02_OveridingDemo {
